...
func _deferred_switch_scene(res_path, spawn_name: String = "SpawnPoint"):
	if player == null:
...
func switch_scene(res_path, spawn_name: String = "SpawnPoint"):
	call_deferred("_deferred_switch_scene", res_path, spawn_name)
